    ...
    <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
            <Image alt="feature" className="object-cover object-center h-full w-full transition-transform duration-500 transform hover:skew-x-12 hover:scale-105"width={600} height={600} src="/logo.jpg"/>
          </div>
        ...
        {`
          ...
          /* Apply animation to the image to simulate wind effect */
          .flag-wave {
